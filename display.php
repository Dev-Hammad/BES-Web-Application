...
<body>
    ...
    <div class="mt-5 mb-5" style="background-color:white;padding:1%;">
        ...
        ?>
            ...
            ?>
        <?php
        } else if ($_SESSION["fee_pay"] != null) {
        ?>
            <div class="alert alert-success alert-dismissible mt-2" style="margin-bottom: 0px;margin-top: 10px;">
                <button id="fp" type="button" class="close" data-dismiss="alert">&times;</button>
                <strong>Successfully Fees Paid From</strong> <?php echo $_SESSION["fee_pay"] ?>.
            </div>
        <?php
        }
        ?>
        <br>
        <table style="font-size: small;width:100%" class="text-nowrap row-border hover order-column table table-bordered table-bordered table-light table-hover table-striped text-center table-responsive-sm  table-responsive-md  table-responsive-lg table-fixed">
            ...
            <tbody id="myTable">
                ...
                ?>
                    ...
                    if (
                        ...
                        $row["s_id"] == $_SESSION["recycle_record"] ||
                        $row["s_name"] == $_SESSION["Update"]  ||
                        $row["s_name"] == $_SESSION["fee_pay"]
                    ) {
                    ?>
                        ...
                        <td><?php echo $row["std_adv_fees"] ?></td>
                        ...
                        <td>
                            <div class="container">
                                <div class="row  pl-2">
                                    ...
                                    if ($flag == 1) {
                                    ?>
                                        <a href="./update.php?updateid=<?php echo $row["s_id"] ?>&fee_month=<?php echo $row["s_fee_month"] ?>" class="btn-sm btn btn-primary btn-default btn-block">Update</a>
                                    <?php
                                    } else {
                                    ?>
                                        <a href="./update.php?updateid=<?php echo $row["s_id"] ?>&fee_month=<?php echo $row["s_fee_month"] ?>" class="btn-sm btn btn-outline-primary btn-default btn-block">Update</a>
                                    ...
                                    ?>
                                        ...
                                        <button id="fee_btn" disabled  class="btn-sm p-2 btn btn  btn-outline-success btn-default  btn-block">Fee Pay</button>
                                    <?php
                                    }
                                    ?>
                                    <a href="./View_std_details.php?Dataid=<?php echo $row["s_id"] ?>&fee_month=<?php echo $row["s_fee_month"] ?>" class=" btn-sm btn btn-outline-warning btn-default btn-block">Details</a>
                                </div>
                            </div>
                        </td>
                        </tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <td colspan="2"><b>Total Fees : RS. <?php
                                                        echo  $fees_Total
                                                        ?></b></td>
                    <td> <a href="./preview.php" class="btn btn-outline-success btn-block pl-2 ml-2 ">Preview All Student</a>
                    </td>
                </tr>
            <?php
                    } else {
